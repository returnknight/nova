...
- 资料库：结构化维护角色、世界观、地点、势力、规则和物品等长期设定；角色每章后的当前位置、伤势、心理、目标等当前状态沉淀在 `setting/character-states.md`。
- 角色卡导入：支持 SillyTavern v2 PNG / JSON。
- 本地版本管理：每本书使用 Nova 原生快照创建版本、查看历史、对比差异和恢复，无需 Git。
...
- 资料库：维护角色、世界观、地点、势力、规则和物品；角色当前状态由 `setting/character-states.md` 追踪。
